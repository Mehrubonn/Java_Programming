...
public class OddOrEven {
    public static void main(String[] args) {
        ...
        boolean isEven = number % 2 == 0; // When we divide a number by 2, if the remainder is 0, means teh number is even.
//      boolean isOdd = number % 2 != 0; // When we divide a number by 2, if the remainder is not 0, means teh number is odd.
