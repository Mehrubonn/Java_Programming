...
// allows to set all the instance variables of the object as soon as the object is created
    }
    ...
    public String toString() {
        return "Employee{" +
                ...
                '}';
    }// allows to print the object when its passed in the print statement
}
